...
This is similar to row binding, but we're squishing together columns - whether they match or not. These functions simply use position.  
...
That's all we'll do for column binding. I use joins more than `bind_cols`, but wanted you to see it.  